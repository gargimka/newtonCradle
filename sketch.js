...
function setup() {
	...
	*/
	...
	Engine.run(engine);
    //Render.run(render);
	chain1=new Chain(bobObject1.body,roof1.body);
	chain2=new Chain(bobObject2.body,roof1.body);
	chain3=new Chain(bobObject3.body,roof1.body);
	chain4=new Chain(bobObject4.body,roof1.body);
	chain5=new Chain(bobObject5.body,roof1.body);
}
